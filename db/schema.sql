...
DROP DATABASE IF EXISTS sb_c_2021_2nd_t_production;
CREATE DATABASE sb_c_2021_2nd_t_production;
USE sb_c_2021_2nd_t_production;
...
# 기존 게시물의 작성자를 2번호으로 지정 (Safe Mode ==> disable ) ,  Preferences -> SQL Editor and reconnect.
UPDATE article
SET memberId = 2
WHERE memberId = 0;
